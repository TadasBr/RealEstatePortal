...
builder.Services.AddTransient<ISoldAdvertisementsRepository, SoldAdvertisementsRepository>();
...
builder.WebHost.ConfigureKestrel(options => options.ListenAnyIP(5064));
